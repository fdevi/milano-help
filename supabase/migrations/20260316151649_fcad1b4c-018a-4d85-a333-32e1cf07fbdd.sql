...
BEGIN
  ...
  RAISE WARNING '[toggle_like_annuncio] called annuncio_id=%, actor_id=%', _annuncio_id, _actor_id;
  ...
  IF _exists THEN
    ...
    RAISE WARNING '[toggle_like_annuncio] action=unlike annuncio_id=%, actor_id=%', _annuncio_id, _actor_id;
  ELSE
    ...
    RAISE WARNING '[toggle_like_annuncio] action=like annuncio_id=%, actor_id=%', _annuncio_id, _actor_id;
  END IF;
  ...
  RAISE WARNING '[toggle_like_annuncio] new_count=% annuncio_id=%', COALESCE(_new_count, 0), _annuncio_id;
